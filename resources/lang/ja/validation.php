...
return [
    ...
    */
    ...
    'disagreement_password' => '新しいパスワードが現在のパスワードと同じです。違うパスワードを設定してください。',
    ...
    'old_password'          => ':attributeが間違っています。',
    'present'               => ':attributeには現在時刻を指定してください。',
    'regex'                 => '正しい形式の:attributeを指定してください。',
    'regex_user_name'       => ':attributeは半角英数字、-、_のみを使用してください。',
    ...
    */
    ...
    'attributes' => [
        ...
        'new_password_confirmation' => '確認用のパスワード',
